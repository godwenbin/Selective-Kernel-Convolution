...
class CNN(nn.Module):
    def __init__(self):
        ...
        self.Block1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(5, 1), stride=(2, 1), padding=(0, 0)),
            nn.BatchNorm2d(64),
            nn.ReLU(True)
        )
        ...
        self.Block2 = nn.Sequential(
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=(5, 1), stride=(2, 1), padding=(0, 0)),
            nn.BatchNorm2d(128),
            nn.ReLU(True)
        )

        self.Block3 = nn.Sequential(
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=(5, 1), stride=(2, 1), padding=(0, 0)),
            nn.BatchNorm2d(256),
            nn.ReLU(True),
        )
