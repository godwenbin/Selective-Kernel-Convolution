...
class cnn(nn.Module):
    def __init__(self):
        ...
        self.Block1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(5, 1), stride=(2, 1), padding=(1, 0)),
            nn.BatchNorm2d(64),
            nn.ReLU(True)
        )
...
def test(epoch):
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/unimib/unimib_epoch_b_six',epoch_list)
            # np.save('/home/gaowenbing/desktop/dd/Torch_Har_cbam/store_visual/unimib/unimib_error_b_six',error_list)
