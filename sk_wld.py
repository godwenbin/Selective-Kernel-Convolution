...
train_x = np.load('/mnt/ba3b04da-ce1b-4c21-ad1b-3aff7d337cdf/gaowenbin/Project/SKNet/HAR_Dataset/weakly_data_k/train_x.npy')
shape = train_x.shape
...
train_y = (np.load('/mnt/ba3b04da-ce1b-4c21-ad1b-3aff7d337cdf/gaowenbin/Project/SKNet/HAR_Dataset/weakly_data_k/train_y.npy'))
train_y = torch.from_numpy(train_y)
train_y = train_y.type(torch.FloatTensor).cuda()


test_x = np.load('/mnt/ba3b04da-ce1b-4c21-ad1b-3aff7d337cdf/gaowenbin/Project/SKNet/HAR_Dataset/weakly_data_k/test_x.npy')
test_x = torch.from_numpy(np.reshape(test_x.astype(np.float), [test_x.shape[0], 1, test_x.shape[1], test_x.shape[2]]))
test_x = test_x.type(torch.FloatTensor)

test_y = np.load('/mnt/ba3b04da-ce1b-4c21-ad1b-3aff7d337cdf/gaowenbin/Project/SKNet/HAR_Dataset/weakly_data_k/test_y.npy')
...
testloader = Data.DataLoader(dataset=testset, batch_size=713, shuffle=True, num_workers=0)
...
class SKConv(nn.Module):
    ...
    def forward(self, x):
        ...
        # print('attention_vectors:',attention_vectors)
        # weights_list.append(attention_vectors)
        # np.save("/mnt/ba3b04da-ce1b-4c21-ad1b-3aff7d337cdf/gaowenbin/Project/SKNet/visualize/weakly_label/att_weights.npy",weights_list)
...
class SKNet(nn.Module):
    def __init__(self, M=3, G=32, r=32, stride=1, L=16):
        ...
        self.conv3_sk = SKConv(256, M=M, G=G, r=r, stride=stride, L=L)
